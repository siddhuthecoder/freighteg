            ...
            {datas.map((data) => (
                ...
                <div className="w-[100%] text-sm  mt-2 min-w-[1200px] mx-auto grid grid-cols-6 gap-2">
                    ...
                    <div className="flex flex-col  pt-1 ">
                        ...
                        <div
                        className="text-blue-600 underline text-sm cursor-pointer" onClick={() => handleViewQuotesClick(data)}
                ...
                <button  className="mt-2  text-blue-500 px-3 py-1.5 mr-[-50px] text-sm rounded whitespace-nowrap" onClick={() => handleAssignedVendorsClick(data)}>
                    Assigned Vendors
                    </button>
