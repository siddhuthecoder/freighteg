...
import Details from "../../pages/companyBidDetails/Details";
import Response from "../../pages/companyBidDetails/Response";
import BidVendor from "../../pages/customPopUp/BidVendor";
