...
const Layer1 = () => {
  ...
  const products = [
    {
      name: "Route Details",
      desc: "Effortlessly add a pay to your account hi this is siddhu froms rikaulam",
      img:l1
    },
    {
    ...
    return (
      <>
          <div className="relative w-full flex items-center   rounded-md mt-[20px] pb-5">
            <button onClick={scrollLeft} className="absolute left-0 z-10 p-2 rounded-sm bg-white md:hidden">
              <FaChevronLeft />
            </button>
            <div
            ...
            <button onClick={scrollRight} className="absolute right-0 z-10 p-2 bg-white md:hidden">
              <FaChevronRight />
            </button>
          </div>
      </>
    ...
    <>
      <div className="w-full rounded-md flex justify-center shadoww rounded-md ">
        <div className="w-full md:w-[100%]  mx-auto flex flex-col  ">
          <div className="text-[rgb(19,_38,_68)]  pt-5 text-3xl font-bold not-italic    p-0  sticky left-[20px]">Create Bid</div>
