...
import ViewHistory from "./companyBidDetails/ViewHistory";
import VehicleDetailHistory from "./companyBidDetails/VehicleDetailHistory";
import HistoryDetails from "./companyBidDetails/HistoryDetails";
...
//               All History Bids ({allBidCount || 0})
//             </p>
//           </div>
//         </div>
...
//                           <tr>
//                             <td colSpan="13">
//                               <VehicleDetailHistory rowData={data} />
//                             </td>
//                           </tr>
//                         )}
...
const History = () => {
  ...
  useEffect(() => {
    if (Array.isArray(HistoryBidData)) {
      ...
      console.error("HistoryBidData is not an array:", HistoryBidData);
    }
  }, [HistoryBidData]);
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody>
                {Array.isArray(bidDetails) && bidDetails.length > 0 ? (
                  bidDetails.map((data, index) => {
                    const createdByUserData = userData?.find(
                      (user) => user._id === data.created_by
                    );
