...
//               className="pl-10 pr-4 py-2 w-64 border absolute-left border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-300 transition duration-150 ease-in-out"
//             />
//           </div>
//         </div>
//         <div className="flex items-center">
...
//             <div className="bg-gray-100 rounded-lg shadow p-4  min-w-5 min-h-5">
//               <p className="text-lg font-semibold">
//                 Live ({liveBidData.length || 0})
//               </p>
//             </div>
//             <div className="bg-gray-100 rounded-lg shadow p-4  min-w-5 min-h-5">
...
//                   <th className="py-3 px-4 text-left">Bid Time Remaining</th>
